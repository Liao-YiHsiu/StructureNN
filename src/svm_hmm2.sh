...
. ../timit/path.sh
   ...
   ../svm_hmm/svm_hmm_learn -c 10000 -e 0.5 simp/data.out simp/data.model &>simp/data.log 
   ...
   ../svm_hmm/svm_hmm_classify simp/data.out simp/data.model simp/data.tags &>>simp/data.log 
