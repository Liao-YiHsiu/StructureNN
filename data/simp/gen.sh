...
gen-lab /corpus/timit ~/Research/timit/conf/phones.60-48-39.map ~/Research/timit/data/lang/words.txt ark:train.ark ark:train.lab  || exit 1;
gen-lab /corpus/timit ~/Research/timit/conf/phones.60-48-39.map ~/Research/timit/data/lang/words.txt ark:dev.ark ark:dev.lab  || exit 1;
gen-lab /corpus/timit ~/Research/timit/conf/phones.60-48-39.map ~/Research/timit/data/lang/words.txt ark:test.ark ark:test.lab  || exit 1;
